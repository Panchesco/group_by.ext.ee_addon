...
class Group_by_ext {
    ...
    public function group_by($obj, $query_result)
    {
        ...
        // Get the field_id if the field_name was given.
        $group_by = $this->field_id($group_by);
     ...
     * field_id
     *
     * Return the field_id identefiter for a field_name
     *
     * @param $field_name string
     * @return string
     */
     protected function field_id( $field_name ) {
...
/* Location: /system/expressionengine/user/addons/group_by/ext.group_by.php */